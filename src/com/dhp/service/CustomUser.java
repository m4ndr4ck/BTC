...
public class CustomUser implements UserDetails, CredentialsContainer {
	 ...
	 */
	public CustomUser(String cpf, String password, String nome, long id, int verificado,
			Collection<? extends GrantedAuthority> authorities) {
		this(cpf, password, nome, id, verificado, true, true, true, true, authorities);
	}
	 ...
	 */
	public CustomUser(String cpf, String password, String nome, long id, int verificado, boolean enabled,
			boolean accountNonExpired, boolean credentialsNonExpired,
			boolean accountNonLocked, Collection<? extends GrantedAuthority> authorities) {

		if (((cpf == null) || "".equals(cpf)) || (password == null)) {
	...
	public boolean equals(Object rhs) {
		if (rhs instanceof CustomUser) {
			return cpf.equals(((CustomUser) rhs).cpf);
		}
		return false;
	}
	...
	public String toString() {
		...
		sb.append("Username: ").append(this.cpf).append("; ");
