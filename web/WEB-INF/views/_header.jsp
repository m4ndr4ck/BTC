...
<script>
  ...
  gtag('config', 'UA-108266698-1');
    ...
    <div>
		...
		<c:if test="${verificado == 0}">
		<div style="color: rgb(203, 150, 175);">
			Cadastro não verificado. <a href="/painel/enviar-documentos" style="
    color: rgba(255, 255, 255, 0.72);">
			Envie seus documentos</a> para poder comprar bitcoin.
		</div>
		</c:if>
      
<div id="cotacaoDiv" class="header clearfix jumbotron">
	<h3 class="text-muted" id="cotacaoH3">
      Cotação: <b>1 BTC | ${cotacaoCOMPRA}</b><span style="margin-left: 5px;">
	</h3>
</div>    
