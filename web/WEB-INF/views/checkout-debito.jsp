...
<script>
    ...
    function efetivaPagamento(dadosComprador){
        ...
        // pegando os dados
        var vUrl = "/painel/checkout/debito/";
        var vData = {
...
">Endereço</div>
    ...
    padding-bottom: 0px;
    border-bottom: solid 1px #b3b3b3;
">Selecione seu banco</div><br>

                <div class="form-group">
                    <br>
                    <label class="radio-inline">
                        <input type="radio" name="banco" value="bradesco" required>Bradesco
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="banco" value="itau" required>Itaú
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="banco" value="bb" required>Banco do Brasil
                    </label>
                </div>
    ...
    <div id="sucesso" style="display:none;width: 50%;margin: auto;">
        ...
        <br><br>
        Para finalizar o pagamento você precisa transferir o dinheiro através do seu banco:
        <br><br>
        <a id="linkpagamento" target="_blank">Ir para o meu banco</a>
    </div>
