...
<script>
    ...
    $(document).ready(function () {
        $("form").submit(function( event ) {
          //  console.log( $( this ).serializeArray() );
            ...
            var validade = map['validade'];
            var arr = validade.split('/');
            var mesExpiracao = arr[0];
            var anoExpiracao = "20" + arr[1];
            ...
            PagSeguroDirectPayment.createCardToken({
                ...
                success: function (response) {
                    ...
                    //Chama funcao que efetiva pagamento
                    efetivaPagamento(response.card.token, map)
                },
    ...
    function efetivaPagamento(token, dadosComprador){
        ...
        $(document).ready(function () {
            ...
            // pegando os dados
            var vUrl = "/painel/checkout/cartao/";
            var vData = {
...
">Endereço</div>
    ...
    padding-bottom: 0px;
    border-bottom: solid 1px #b3b3b3;
">Dados do Cartão de Crédito</div><br>

            <div class="form-group">
                <input type="text" class="form-control" id="input-placeholder" id="numerocartao" name="numerocartao" value="" placeholder="Número do cartão" maxlength="16" required>
            </div>
            <div class="row">
                <div class="col-xs-6">
                    <input type="text" class="form-control" id="validade" name="validade" placeholder="Data de Validade" required>

                </div>

                <div class="col-xs-6">
                    <input type="text" class="form-control" id="cvv" name="cvv" placeholder="Código de Segurança" required>
                </div>
            </div>
            <br>
            <div id="cartaoinvalido" style="color: #a75f5f;display:none">
    ...
    <div id="sucesso" style="display:none;width: 50%;margin: auto;">
        ...
        <br><br>
        <b>Pagamento processado com sucesso</b>
        <br><br>
        Seu pagamento está em análise. Assim que for aprovado, seu bitcoin será liberado em até 24 horas.
    </div>

    <div id="erro" style="display:none;width: 50%;margin: auto;">
        <img src="/resources/img/erro.png">
        <br><br>
        <b>Houve um erro ao processar o pagamento</b>
        <br><br>
        Revise seus dados e tente fazer a compra novamente. Se o problema persistir, utilize outro cartão.
    </div>
